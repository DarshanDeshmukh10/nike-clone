...
const HeroBanner = () => {
  return (
    <div className='relative text-white text-[20px] w-full max-w-[1100px] mx-auto'>
       <Carousel autoPlay={true} infiniteLoop={true} showThumbs={false}  showIndicators={false} showStatus={false}
            ...
            >
                <div>
                    ...
                    <div className='px-[15px] md:px-[40px] py-[20px] md:py-[25px] font-oswald bg-white absolute bottom-[25px] md:bottom-[75px] left-0 text-black/[0.9] text-[15px] md:text[30px] uppercase font-medium cursor-pointer hover:opacity-90]'>Shop now</div>
                 </div>
